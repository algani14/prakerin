...
<head>
  ...
  <!-- easy pie chart-->
  <link href="{{asset('assets2/jquery-easy-pie-chart/jquery.easy-pie-chart.css')}}" rel="stylesheet" type="text/css" media="screen" />
  <!-- owl carousel -->
...
<body>
  ...
  <<script src="{{asset('js2/fullcalendar.min.js')}}"></script>
